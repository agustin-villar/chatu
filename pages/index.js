    ...
    <div className={styles.container}>
      ...
      <footer className={styles.footer}>
        <ol className={styles.footnotes}>
          ...
          <li id="3">
            De acuerdo con fuentes de alta fidelidad (Esto me lo conto Nati 👀) "Alfil" en español se utiliza únicamente y exclusivamente para nombrar esa ficha del
            ajedrez, no tiene ningún otro significado como los caballos o las torres. "Al fil" son originalmente dos palabras árabes que traducen
            "El elefante". Esto probablemente no tendría mucho sentido para los ingleses quienes optaron por llamar "Bishops" (Obispos) a los alfiles,
            que aunque no eran visualmente tan imponentes como los elefantes, si fueron personajes muy influyentes en las sociedades de Europa Occidental
